...
df_chf = pd.read_csv('data/CHF.csv', encoding='Windows-1250', sep=';', parse_dates=['Data'])

df_his['#Data księgowania'] = pd.to_datetime(df_his['#Data księgowania'], format="%d-%m-%Y")
df_his_short = df_his.loc[df_his['#Opis'].str.contains('SPŁATA'), ['#Data księgowania', '#Kwota', '#Kwota pozostała do spłaty']]
